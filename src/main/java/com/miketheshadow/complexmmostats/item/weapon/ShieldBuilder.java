...
//    public static ItemStack createShield(String weaponName, String weaponType, int handling, int defense, int durability, HashMap<ItemStat, Integer> stats, int rarity, Material material, Player player) {
//
