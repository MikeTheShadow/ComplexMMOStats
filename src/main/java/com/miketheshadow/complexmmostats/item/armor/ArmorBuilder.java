...
public class ArmorBuilder extends ItemBuilder {
    ...
    public static ItemStack createArmor(String weaponName, int handling, int defense, int durability, HashMap<Stat,Integer> stats, int rarity, Material material,String armorName, Player player) {
